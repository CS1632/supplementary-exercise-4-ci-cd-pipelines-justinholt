...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		...
		assertNull("Cat should be null", cat);
	}
	...
	public void testGetCatNumCats3() {
		...
		assertEquals("Cat should have an ID of 2", 2, cat.getId());
	}
	...
	public void testCatAvailableFalseNumCats0() {
		...
		assertFalse("Cat shouldn't be available", available);
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		assertTrue("Cat should be available", available);
	}
	...
	public void testCatExistsFalseNumCats0() {
		...
		assertFalse("Cat shouldn't exist", exists);
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		assertTrue("Cat should exist", exists);
	}
	...
	public void testListCatsNumCats0() {
		...
		assertEquals("List should be empty", "", list);
	}
	...
	public void testListCatsNumCats3() {
		...
		assertEquals("List should have 3 cats", "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", list);
	}
	...
	public void testRentCatFailureNumCats0() {
		...
		assertFalse("Cat shouldn't be rented", rented);
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		assertFalse("Cat shouldn't be re-rented", rented);
	}
	...
	public void testReturnCatFailureNumCats0() {
		...
		assertFalse("Cat shouldn't be returned--doesn't exist", returned);
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("Cat should've been returned", returned);
	}
}
